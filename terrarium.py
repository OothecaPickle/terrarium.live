...
CAMERAS = {
    "1":  ("Foyer",			"foyr"),
    "2":  ("Bar",			"bar"),
    "3":  ("Bar Alternate",		"brrr2"),
    "4":  ("Bar PTZ",			"brpz"),
    "5":  ("Kitchen",			"ktch"),
    "6":  ("Dining Room",		"dnrm"),
    "7":  ("Hallway Up (West Wing)",	"hwup"),
    "8":  ("Corridor",			"codr"),
    "9":  ("Confessional",		"cfsl"),
    "10": ("Bedroom 4 (Jungle Room)",	"br4j"),
    "11": ("Bedroom 3 (Goo Room)",	"br3g"),
    "12": ("Balcony (East Wing)",	"bkny"),
    "13": ("Bedroom 2 (Computer Lab)",	"computer-lab2"),
    "14": ("Bedroom 1 (Arena)",		"bare"),
    "15": ("Glassroom",			"gsrm"),
    "16": ("Market",			"mrke"),
    "17": ("Market Alternate",		"mrke2"),
    "18": ("Hallway Down",		"hwdn"),
    "19": ("Dorm",			"dmrm"),
    "20": ("Dorm Alternate",		"dmrm2"),
    "21": ("Closet",			"dmcl"),
    "22": ("Jacuzzi",			"jckz"),
    "23": ("Director Mode",		"dirc"),
    "24": ("Cameraman",			"cameraman2"),
    "25": ("jetnep",			"jet"),
    "26": ("bendub",			"ben"),
    "27": ("Laura",			"laura"),
    "28": ("Damiel",			"damiel"),
