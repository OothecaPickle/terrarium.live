...
CAMERAS = {
    "1":  ("Foyer",			"foyr"),
    "2":  ("Bar Alternate",		"brrr2"),
    "3":  ("Bar PTZ",			"brpz"),
    "4":  ("Kitchen",			"ktch"),
    "5":  ("Dining Room",		"dnrm"),
    "6":  ("Hallway Up (West Wing)",	"hwup"),
    "7":  ("Corridor",			"codr"),
    "8":  ("Confessional",		"cfsl"),
    "9":  ("Bedroom 4 (Jungle Room)",	"br4j"),
    "10": ("Bedroom 3 (Goo Room)",	"br3g"),
    "11": ("Balcony (East Wing)",	"bkny"),
    "12": ("Bedroom 2 (Computer Lab)",	"computer-lab2"),
    "13": ("Bedroom 1 (Arena)",		"bare"),
    "14": ("Glassroom",			"gsrm"),
    "15": ("Market",			"mrke"),
    "16": ("Market Alternate",		"mrke2"),
    "17": ("Hallway Down",		"hwdn"),
    "18": ("Dorm",			"dmrm"),
